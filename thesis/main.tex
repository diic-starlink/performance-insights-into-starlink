...
%    \boldNumberSetsfalse % Use this value if you want variables for number sets (like N or R) to appear in blackboard bold rather than bold.
    ...
    \myTitle{Starlink Thesis}{Eine adäquate Übersetzung meines Titels}
    ...
    \myKeywords{master thesis | starlink | spacex | satellite web | data-intensive internet computer | vaibhav bajpai}
