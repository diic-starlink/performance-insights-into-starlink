...
% Input IP Hitlist
\input{./chapters/img/ip-hitlist.tex}
...
% TODO:
% Add proof that the data is flowing into the US. Add a chart showing the top hit IP addresses for an EU probe tracerouting
% to an any casted root-server.
