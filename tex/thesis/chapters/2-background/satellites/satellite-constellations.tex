...
\Cref{fig:growth-satellite-constellations} shows various satellite
constellations with the number of satellites it consisted of per year.
\Cref{fig:satellite-constellations-short} show the corresponding numbers,
...
growth in recent years. However, this is also due to the requirement of
\ac{LEO} constellations (i.e., Starlink and OneWeb) of having significantly
more satellites, compared to \ac{GEO} constellations (e.g., Intelsat and
O3B~Networks).
