\subsection{Latency and Packet Loss Correlation} \label{sec:latency-packetloss-correlation}
...
are shown in \Cref{fig:packetloss-latency-correlation}.
...
\Cref{fig:packetloss-latency-correlation-2022,
	fig:packetloss-latency-correlation-2023,
	fig:packetloss-latency-correlation-2024} show the individual
correlation values for the years 2022 to 2024. There are only countries
displayed, where a correlation value could be calculated.
...
\Cref{fig:packetloss-latency-correlation} and correlated it with the number of
probes available for RIPE Atlas in each country. The resulting table is shown
in \Cref{fig:packetloss-latency-number-probes-correlation}.
