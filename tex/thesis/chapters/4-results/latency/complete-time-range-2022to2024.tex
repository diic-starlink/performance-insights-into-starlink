...
\begin{figure}
	...
	\begin{subfigure}[b]{0.3\linewidth}
		\includegraphics[width=\linewidth]{chapters/4-results/latency/img/histogram_latencies_in_2022_of_starlink_probes_in_canada.pdf}
	\end{subfigure}
	\begin{subfigure}[b]{0.3\linewidth}
		\includegraphics[width=\linewidth]{chapters/4-results/latency/img/histogram_latencies_in_2023_of_starlink_probes_in_canada.pdf}
	\end{subfigure}
	\begin{subfigure}[b]{0.3\linewidth}
		\includegraphics[width=\linewidth]{chapters/4-results/latency/img/histogram_latencies_in_2024_of_starlink_probes_in_canada.pdf}
	\end{subfigure}
