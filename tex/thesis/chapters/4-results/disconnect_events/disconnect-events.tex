...
Atlas. \Cref{fig:disconnect-events-absolute} shows the number of disconnect
...
significant spikes. \Cref{fig:disconnect-events-absolute-all-countries}
...
\Cref{fig:disconnect-events-absolute-all-countries} does not allow making
...
data needs to be normalized. In \Cref{sec:correlation-disconnect-events}, we
