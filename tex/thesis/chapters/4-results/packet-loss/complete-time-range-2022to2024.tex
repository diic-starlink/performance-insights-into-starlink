...
\Cref{fig:packetloss-total} shows the resulting packet losses in percent per
country.
...
\Cref{fig:packet-loss-fine-grained} show the packet loss ratios for each month
...
\Cref{fig:packetloss-total}. The USA was chosen, as it holds the most data and
