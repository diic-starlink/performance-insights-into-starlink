...
By running ping measurements, we intend to measure \ac{RTT} and packet loss. The ping measurement runs every five minutes and pings a specific server. \todo{Which Server? In my setup usually and NCC server.}
